...
import { threatIntelFieldMap } from '../field_maps/threat_intel_field_map';

export const threatIntelComponentTemplate: ClusterPutComponentTemplateBody = {
  template: {
    settings: {
      number_of_shards: 1,
    },
    mappings: merge(
      ...
      mappingFromFieldMap(threatIntelFieldMap)
    ),
  },
};
